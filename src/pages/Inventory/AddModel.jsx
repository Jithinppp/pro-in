                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-4 space-y-4">
                    {success && (
                        <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                            <p className="text-sm text-green-700">Model created successfully!</p>
                        </div>
                    )}
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            {...register("brand_code", { required: "Brand code is required" })}
                            className="w-full px-3 py-2.5 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                            placeholder="e.g., BSH"
                        />
                        {errors.brand_code && (
                            <p className="text-red-500 text-xs mt-1">{errors.brand_code.message}</p>
                        )}
                        <p className="text-xs text-gray-500 mt-1">Used in asset code generation</p>
                    </div>
